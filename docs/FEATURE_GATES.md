...
| KG-002 | CODE_READY_UNVERIFIED | Reader daily usability: page fit, gestures, tap zones, progress, controls. | `entry/src/main/ets/pages/ReaderPage.ets`<br>`entry/src/main/ets/components/ReaderChrome.ets`<br>`entry/src/main/ets/model/ReaderPreferencesStore.ets`<br>`entry/src/main/ets/state/ReaderModeState.ets`<br>`entry/src/main/ets/model/ReaderPageIndexDataSource.ets`<br>`entry/src/main/ets/model/ReaderTapZoneGeometry.ets`<br>`entry/src/main/ets/model/ReaderSessionStore.ets`<br>`entry/src/main/ets/model/ComicModels.ets`<br>`entry/src/main/ets/model/ReaderPageSourceAdapter.ets`<br>`entry/src/main/ets/model/RemoteProgressSyncService.ets`<br>`entry/src/main/ets/sourceRuntime/SourceRuntimeDeviceSmoke.ets`<br>`entry/src/main/ets/pages/SettingsPage.ets`<br>`entry/src/main/ets/pages/Index.ets`<br>`entry/src/main/ets/model/BackupService.ets`<br>`entry/src/main/ets/theme/ThemeConstants.ets`<br>`entry/src/main/resources/` | `.hermes-artifacts/reader-migration/current/recheck-20260811/` current device evidence | Current build Reader QA matrix on connected device, including single page, continuous, zoom/double-tap, tap navigation, chrome open/close, image actions, and close/reopen progress. |
| KG-003 | CODE_READY_UNVERIFIED | Source project development to Koma app usage loop. | `entry/src/main/ets/sourceRuntime/`<br>`entry/src/main/ets/state/SourceRuntimeState.ets`<br>`scripts/run_source_*`<br>`docs/source-*.md` | `.hermes-artifacts/` pending current accepted run | Build a local `.koma` package, install through Koma, search/open/download/read from UI with current device evidence. |
| KG-004 | REOPENED | App visible page baseline: root/library/browse/search/detail, Reader shell, and navigation scaffold. | `entry/src/main/ets/common/RouterHelper.ets`<br>`entry/src/main/ets/model/CrossSearchService.ets`<br>`entry/src/main/ets/pages/Index.ets`<br>`entry/src/main/ets/pages/LibraryPage.ets`<br>`entry/src/main/ets/pages/HistoryPage.ets`<br>`entry/src/main/ets/pages/BrowsePage.ets`<br>`entry/src/main/ets/pages/KomgaSeriesPage.ets`<br>`entry/src/main/ets/pages/OpdsBrowsePage.ets`<br>`entry/src/main/ets/pages/WebDavBrowsePage.ets`<br>`entry/src/main/ets/pages/SearchPage.ets`<br>`entry/src/main/ets/pages/SourceBrowsePage.ets`<br>`entry/src/main/ets/pages/SourceSearchPage.ets`<br>`entry/src/main/ets/pages/MangaDetailPage.ets`<br>`entry/src/main/ets/pages/ReaderPage.ets`<br>`entry/src/main/ets/components/ReaderChrome.ets`<br>`entry/src/main/ets/components/ChapterListSection.ets`<br>`entry/src/main/ets/components/SecondaryListScaffold.ets`<br>`entry/src/main/ets/components/PullRefresh*`<br>`entry/src/main/ets/components/CachedCoverImage.ets`<br>`entry/src/main/ets/components/ComicCoverCard.ets`<br>`entry/src/main/ets/components/ui/KomaMenuChip.ets`<br>`entry/src/main/ets/components/Hds*`<br>`entry/src/main/ets/model/Cover*`<br>`entry/src/main/ets/model/ComicModels.ets`<br>`entry/src/main/ets/model/LibraryUpdateService.ets`<br>`entry/src/main/ets/model/MockLibraryData.ets`<br>`entry/src/main/ets/model/RemoteImageCacheStore.ets`<br>`entry/src/main/ets/remote/KavitaModels.ets`<br>`entry/src/main/ets/sourceRuntime/SourceRuntimeAppRegistry.ets`<br>`entry/src/main/ets/utils/ScrollUserInput.ets` | `.hermes-artifacts/20260813-browse-cover-device-verify/qa/screenshots/03-browse-during-drag.png`<br>`.hermes-artifacts/20260813-browse-cover-device-verify/qa/layouts/03-browse-refresh-settled.json`<br>`.hermes-artifacts/20260813-browse-cover-device-verify/qa/screenshots/10-history-cold-immediate.png`<br>`.hermes-artifacts/20260813-browse-cover-device-verify/qa/layouts/08-history-cold-immediate.json` | Continue the root-tab baseline with current Search, source/detail, and Reader-shell screenshots/layout; this slice verifies Browse refresh plus Library/History cover reentry. |
