...
16. Source browsing has Pura X runtime and UI evidence for MangaDex home/listings/filters, MangaDetail, and Reader; remaining product QA is source-backed download, per-source settings editing, and broader real-source compatibility.
