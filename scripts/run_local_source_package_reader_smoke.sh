...
export KOMA_SOURCE_READER_PHASE="${KOMA_SOURCE_READER_PHASE:-local-source-package-visible-reader}"
...
export KOMA_SOURCE_READER_ARTIFACT_DIR="${KOMA_SOURCE_READER_ARTIFACT_DIR:-.hvigor/outputs/local-source-package-reader-smoke}"
