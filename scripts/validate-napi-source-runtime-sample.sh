...
changed_ui_files="$(git diff --name-only -- entry/src/main/ets/pages entry/src/main/ets/components entry/src/main/ets/model entry/src/main/ets/import entry/src/main/ets/remote entry/src/main/module.json5 | rg -v '^entry/src/main/ets/pages/Index\.ets$|^entry/src/main/ets/pages/ReaderPage\.ets$|^entry/src/main/ets/pages/SourcePackageManagerPage\.ets$|^entry/src/main/ets/pages/MangaDetailPage\.ets$|^entry/src/main/ets/model/ReaderPageSourceAdapter\.ets$|^entry/src/main/ets/model/OfflineDownload(Store|Service)\.ets$|^entry/src/main/ets/model/Source(TextNormalizer|Models)\.ets$|^entry/src/main/ets/model/MangaDetailModels\.ets$|^entry/src/main/ets/viewmodel/BrowseViewModel\.ets$|^entry/src/main/ets/model/BackupService\.ets$' || true)"
