...
changed_ui_files="$(git diff --name-only -- entry/src/main/ets/pages entry/src/main/ets/components entry/src/main/ets/model entry/src/main/ets/import entry/src/main/ets/remote entry/src/main/module.json5 | rg -v '^entry/src/main/ets/pages/Index\.ets$|^entry/src/main/ets/pages/LibraryPage\.ets$|^entry/src/main/ets/pages/ReaderPage\.ets$|^entry/src/main/ets/pages/SettingsPage\.ets$|^entry/src/main/ets/pages/LibraryUpdateResultPage\.ets$|^entry/src/main/ets/pages/SourcePackageManagerPage\.ets$|^entry/src/main/ets/pages/Source(Browse|Search)Page\.ets$|^entry/src/main/ets/pages/MangaDetailPage\.ets$|^entry/src/main/ets/components/ReaderChrome\.ets$|^entry/src/main/ets/components/SourceListItem\.ets$|^entry/src/main/ets/model/ComicModels\.ets$|^entry/src/main/ets/model/Library(FilterStore|Persistence|Store)\.ets$|^entry/src/main/ets/model/LibraryUpdateResultStore\.ets$|^entry/src/main/ets/model/Reader(PageSourceAdapter|PreferencesStore)\.ets$|^entry/src/main/ets/model/OfflineDownload(Store|Service)\.ets$|^entry/src/main/ets/model/Source(TextNormalizer|Models)\.ets$|^entry/src/main/ets/model/MangaDetailModels\.ets$|^entry/src/main/ets/viewmodel/BrowseViewModel\.ets$|^entry/src/main/ets/model/BackupService\.ets$' || true)"
