...
export KOMA_SOURCE_READER_PHASE="${KOMA_SOURCE_READER_PHASE:-local-library-folder-reader}"
export KOMA_SOURCE_READER_REQUIRES_INDEX="${KOMA_SOURCE_READER_REQUIRES_INDEX:-false}"
export KOMA_SOURCE_READER_CAPTURE_UI="${KOMA_SOURCE_READER_CAPTURE_UI:-false}"
