...
assert.match(readerPageSource, /pushReadingProgress\(progress, this\.sessionConfig\.chapterIds\)/, 'ReaderPage tracker sync must use reader session chapter ids for provider chapter progress')
