...
def main() -> int:
    ...
    try:
        ...
        with zipfile.ZipFile(archive_path, "r") as archive:
            ...
            source_repo_layout = names == [SOURCE_REPO_MANIFEST_NAME, SOURCE_REPO_WASM_NAME]
        ...
        if internal_layout:
            ...
            report["evidence"].extend([
                "archive contains deterministic source-repo manifest.json and source.wasm entries",
